...
<head>
    ...
    <title>Alış Qaimələri – AurumAccounting</title>
    <link rel="stylesheet" href="../assets/css/style.css">
</head>
<body data-page="purchase-bills" class="app-page">
...
<div class="app-layout">
    ...
    <main class="app-main">
        ...
        <div class="app-main__header">
            <div>
                <h1 class="app-main__title">Alış Qaimələri</h1>
                <p class="app-main__subtitle">Təchizatçılardan alış sənədləri</p>
            </div>
        ...
        <div class="invoice-stats">
            <div class="invoice-stat-card">
                <div class="invoice-stat-card__icon" style="background: linear-gradient(135deg, #E17B77, #C85C58);">
            ...
            <div class="invoice-stat-card">
                <div class="invoice-stat-card__icon" style="background: linear-gradient(135deg, #7BB3DB, #5A9AC7);">
                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round">
        ...
        <div class="invoice-filters">
            <div class="form-group" style="flex: 1; margin-bottom: 0;">
                <input type="search" id="searchBills" class="form-input form-input--search" placeholder="Qaimə №, təchizatçı adı ilə axtarış... ">
            </div>
...
<!-- Add/Edit Bill Modal -->
<div class="modal modal--xl" id="billModal" role="dialog" aria-modal="true" hidden>
    <div class="modal__backdrop" data-modal-close></div>
    <div class="modal__content">
        <div class="modal__header">
            <h2 class="modal__title" id="modalTitle">Yeni Alış Qaiməsi</h2>
        ...
        <form id="billForm" class="modal__body invoice-form" novalidate>
            <!-- Header -->
            <div class="invoice-form-header">
                <div class="form-row">
                    <div class="form-group">
                        <label for="billNumber" class="form-label form-label--required">Qaimə №</label>
                        <input type="text" id="billNumber" name="bill_number" class="form-input" required placeholder="BILL-2026-001">
                    </div>
                    <div class="form-group">
                        <label for="billDate" class="form-label form-label--required">Tarix</label>
                        <input type="date" id="billDate" name="bill_date" class="form-input" required>
                    </div>
                    <div class="form-group">
                        <label for="dueDateBill" class="form-label form-label--required">Son Ödəniş Tarixi</label>
                        <input type="date" id="dueDateBill" name="due_date" class="form-input" required>
                    </div>
                    <div class="form-group">
                        <label for="statusBill" class="form-label form-label--required">Status</label>
                        <select id="statusBill" name="status" class="form-select" required>
                            <option value="draft">Qaralama</option>
                            <option value="sent">Göndərilib</option>
                            <option value="paid">Ödənilib</option>
                            <option value="cancelled">Ləğv Edilib</option>
                ...
                <div class="invoice-customer-section">
                    <h3>Təchizatçı Məlumatı</h3>
                    <div class="form-row">
                        <div class="form-group">
                            <label for="vendorName" class="form-label form-label--required">Təchizatçı Adı</label>
                            <input type="text" id="vendorName" name="vendor_name" class="form-input" required>
                        </div>
                        <div class="form-group">
                            <label for="vendorTaxId" class="form-label">VÖEN</label>
                            <input type="text" id="vendorTaxId" name="vendor_tax_id" class="form-input">
                        </div>
                    </div>
                    <div class="form-row">
                        <div class="form-group">
                            <label for="vendorEmail" class="form-label">Email</label>
                            <input type="email" id="vendorEmail" name="vendor_email" class="form-input">
                        </div>
                        <div class="form-group">
                            <label for="vendorPhone" class="form-label">Telefon</label>
                            <input type="tel" id="vendorPhone" name="vendor_phone" class="form-input">
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="vendorAddress" class="form-label">Ünvan</label>
                        <input type="text" id="vendorAddress" name="vendor_address" class="form-input">
                    </div>
                </div>
            </div>
            ...
            <!-- Notes -->
            <div class="form-group">
                <label for="notesBill" class="form-label">Qeydlər</label>
                <textarea id="notesBill" name="notes" class="form-textarea" rows="2" placeholder="Əlavə qeydlər... "></textarea>
            </div>
...
<div class="modal modal--lg" id="viewModal" role="dialog" aria-modal="true" hidden>
    ...
    <div class="modal__content">
        <div class="modal__header">
            <h2 class="modal__title" id="viewModalTitle">Alış Qaiməsi</h2>
